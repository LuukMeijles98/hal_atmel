/*
 * manually altered from saml21g-pinctrl.h
 *
...
/* pb2h_supc_out1 */
#define PB2H_SUPC_OUT1 \
	SAM_PINMUX(b, 2, h, periph)

/* pb2i_ccl0_out */
#define PB2I_CCL0_OUT \
...
/* pb3h_supc_vbat */
#define PB3H_SUPC_VBAT \
	SAM_PINMUX(b, 3, h, periph)
